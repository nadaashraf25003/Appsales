  ...
  admin: {
    ...
    sideNav: [
      ...
      },
      {
        ...
        icon: "Apartment",
        items: [
          { title: "Branches", icon: "Apartment", url: "/erp/branches" },
          { title: "Create Branch", icon: "Add", url: "/erp/branches/create" },
          { title: "Tenants", icon: "Apartment", url: "/erp/tenants" },
    ...
    routes: {
      ...
      inventory: [
        ...
        { path: "/erp/inventory/items/new", name: "New Product" },
        { path: "/erp/inventory/materials", name: "Raw Materials" },
        { path: "/erp/inventory/materials/new", name: "New Material" },
      ...
      settings: [
        { path: "/erp/settings/general", name: "General Settings" },
        { path: "/erp/settings/financial", name: "Financial Settings" },
        { path: "/erp/settings/users", name: "User Management" },
        { path: "/erp/settings/users/:id/edit", name: "Edit User" },
        { path: "/erp/settings/users/new", name: "Add User" },
        { path: "/erp/settings/organization", name: "Organization Settings" },
      ],
    },
  },
};