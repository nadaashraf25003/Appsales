...
const Activities = () => {
  ...
  // Fetch data
  const { data: ordersResponse, isLoading: ordersLoading, refetch: refetchOrders } = getOrdersByTenantQuery(tenantId);
  const { data: customersResponse, isLoading: customersLoading } = getAllCustomersQuery();
  const { data: expensesResponse, isLoading: expensesLoading, refetch: refetchExpenses } = getAllExpensesQuery(tenantId);
  ...
  // Loading state
  const loading = isLoading || ordersLoading || customersLoading || expensesLoading;
  ...
  const allActivities = useMemo(() => {
    ...
    const orderActivities = orders.map((order) => ({
      ...
      description: order.status === "1" ? "Order completed successfully" : 
                  order.status === "0" ? "Order placed and pending" : "Order updated",
    ...
    const combined = [...orderActivities, ...customerActivities, ...expenseActivities];
      ...
      <div className="max-w-7xl mx-auto animate-slideDown">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-xs text-gray-500 dark:text-gray-400">Current Tenant</div>
              ...
              >
                <svg className={`w-5 h-5 text-gray-600 dark:text-gray-400 ${isLoading ? 'animate-spin' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400">
              <span className="font-medium text-green-600 dark:text-green-400">{stats.today}</span> today
            </div>
          </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className={`p-3 rounded-xl ${
                    ...
                    activity.type === "customer" ? "bg-blue-100 dark:bg-blue-900/30" :
            ...
            {filteredActivities.length === 0 && (
              <div className="p-12 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                  There are no activities for Tenant #{tenantId}. Try switching to a different tenant.
                </p>
                <button
                  onClick={() => setShowTenantModal(true)}
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <div>
                <div className="font-medium text-gray-900 dark:text-white">Order Activities</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">New orders, status updates, completions</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
              ...
              <div>
                <div className="font-medium text-gray-900 dark:text-white">Customer Activities</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">New registrations, profile updates</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <div>
                <div className="font-medium text-gray-900 dark:text-white">Expense Activities</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">New expenses, updates, deletions</div>
              </div>
            </div>
          </div>
        </div>
